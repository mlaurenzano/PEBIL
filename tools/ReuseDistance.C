...
#define INST_LIB_NAME "libreusedistance.so"

#define NOSTRING "__pebil_no_string__"
#define BUFFER_ENTRIES 0x10000

extern "C" {
    InstrumentationTool* ReuseDistanceMaker(ElfFile* elf){
        return new ReuseDistance(elf);
    }
}

void ReuseDistance::filterBBs(){
...
ReuseDistance::ReuseDistance(ElfFile* elf)
