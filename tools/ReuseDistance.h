...
#ifndef _ReuseDistance_h_
#define _ReuseDistance_h_

#include <InstrumentationTool.h>
#include <SimpleHash.h>

class ReuseDistance : public InstrumentationTool {
private:
...
public:
    ReuseDistance(ElfFile* elf);
    ~ReuseDistance();

    void declare();
    void instrument();

    const char* briefName() { return "ReuseDistance"; }
    const char* defaultExtension() { return "reuse"; }
