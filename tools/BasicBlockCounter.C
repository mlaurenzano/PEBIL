...
void RareEventCounter::declare(){
    BasicBlockCounter::declare();

    exitRare = declareFunction(EXIT_RARE);
    ASSERT(exitRare && "Cannot find exit function, are you sure it was declared?");
