...
for k in inp_hash.keys():
    ...
    if int(block_data[12]) != -1:
        ...
        loop_info[15] += int(block_data[36])
        loop_info[16] += int(block_data[37])
        loop_info[17] += int(block_data[38])
        loop_info[18] += int(block_data[39])
        loop_info[19] += int(block_data[40])
        loop_info[20] += int(block_data[41])
