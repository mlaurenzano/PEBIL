...
CALLED_DIR=`pwd`
MIC_PEBIL_DIR="/ssd/allysonc/Repos/PEBIL"
MIC_LIB_DIR="${MIC_PEBIL_DIR}/miclib"
...
instrument_and_run()
{
  ...
  then
    ...
    ${CALL_MIC} "cd ${CURR_DIR}; PEBIL_ROOT=${MIC_PEBIL_DIR} LD_LIBRARY_PATH=${MIC_LD_LIB_PATH} ./${INST_PROGRAM} &> ${INST_OUTFILE}"
