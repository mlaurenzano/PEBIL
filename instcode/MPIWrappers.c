...
int __wrapper_name(MPI_File_iread_at_all)(MPI_File fh, MPI_Offset offset, void* buf, int count, MPI_Datatype datatype, MPI_Status* status){
    ...
    stoptimer();
    PRINT_INSTR(logfile, "MPI_File_iread_at_all ([%d]%s:%d): mpifile=%d offset=%d count=%d timer=%lld", *currentSiteIndex, fileNames[*currentSiteIndex], lineNumbers[*currentSiteIndex], fh, offset, count, gettimer());
    return retval;
}
*/
...
int __wrapper_name(MPI_File_iread_all)(MPI_File fh, void* buf, int count, MPI_Datatype datatype, MPI_Status* status){
    ...
    stoptimer();
    PRINT_INSTR(logfile, "MPI_File_iread_all ([%d]%s:%d): mpifile=%d count=%d timer=%lld", *currentSiteIndex, fileNames[*currentSiteIndex], lineNumbers[*currentSiteIndex], fh, count, gettimer());
    return retval;
}
*/
// MPI IO write calls
...
int __wrapper_name(MPI_File_iwrite_at_all)(MPI_File fh, MPI_Offset offset, void* buf, int count, MPI_Datatype datatype, MPI_Status* status){
    ...
    stoptimer();
    PRINT_INSTR(logfile, "MPI_File_iwrite_at_all ([%d]%s:%d): mpifile=%d offset=%d count=%d timer=%lld", *currentSiteIndex, fileNames[*currentSiteIndex], lineNumbers[*currentSiteIndex], fh, offset, count, gettimer());
    return retval;
}
*/
