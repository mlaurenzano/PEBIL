...
Vector<Instruction*>* TextObject::digestLinear(){
    ...
    while (currByte < sizeInBytes){
        ...
        Instruction* newInstruction = new Instruction(textSection, getBaseAddress() + currByte, charStream() + currByte, ByteSource_Application_FreeText, numberOfInstructions++, true);
