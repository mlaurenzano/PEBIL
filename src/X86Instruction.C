...
//    mkclass(      vbroadcast,      move,        0,    0,    0,    0,     0)
    ...
    mkclass(  vbroadcasti128,  simdMove,        0,    0,    0,    0,     0)
    mkclass(  vbroadcastf128,  simdMove,        0,    0,    0,    0,     0)
    ...
    mkclass(    vbroadcastsd,      move,   floats,    0,    VRSZ,    0,    64)
    mkclass(    vbroadcastss,      move,   floats,    0,    VRSZ,    0,    32)
    ...
    mkclass(    vextractf128,   simdMove,       0,    0,    VRSZ,    0,   128)
    ...
    mkclass(    vextracti128,   simdMove,       0,    0,    VRSZ,    0,   128)
    ...
    mkclass(      vextractps,       move,   float,    0,     128,    0,    32)
    ...
    mkclass(       vmovntdqa,   simdMove,         0,    0,       0,    0,    0)
    ...
    mkclass(    vpbroadcastmb2q,    move,    intv,    0,    VRSZ,    0,    8)
    mkclass(    vpbroadcastmw2d,    move,    intv,    0,    VRSZ,    0,    16)
    ...
    mkclass(         vpextrb,       move,   float,    0,    VRSZ,    0,    8)
    mkclass(         vpextrd,       move,   float,    0,    VRSZ,    0,    32)
    mkclass(         vpextrq,       move,   float,    0,    VRSZ,    0,    64)
    mkclass(         vpextrw,       move,   float,    0,    VRSZ,    0,    16)
