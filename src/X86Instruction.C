...
void X86InstructionClassifier::generateTable(){
    ...
    mkclass(    vbroadcastss,    move,     floats,    0,      32,    0,    32)
    ...
    mkclass(      vgatherdpd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(      vgatherdps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(   vgatherpf0dps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(vgatherpf0hintdpd,      move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(vgatherpf0hintdps,      move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(   vgatherpf1dps,       move,    floatv,    0,    VRSZ,    0,    32)
    ...
    mkclass(   vloadunpackhd,       move,      intv,    0,    VRSZ,    0,    32)
    mkclass(  vloadunpackhpd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(  vloadunpackhps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(   vloadunpackhq,       move,      intv,    0,    VRSZ,    0,    64)
    mkclass(   vloadunpackld,       move,      intv,    0,    VRSZ,    0,    32)
    mkclass(  vloadunpacklpd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(  vloadunpacklps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(   vloadunpacklq,       move,      intv,    0,    VRSZ,    0,    64)
    ...
    mkclass(         vmovapd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(         vmovaps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(           vmovd,       move,         0,    0,       0,    0,    0)
    mkclass(        vmovddup,       move,         0,    0,       0,    0,    0)
    mkclass(         vmovdqa,       move,         0,    0,       0,    0,    0)
    mkclass(       vmovdqa32,       move,         0,    0,       0,    0,    0)
    mkclass(       vmovdqa64,       move,         0,    0,       0,    0,    0)
    ...
    mkclass(       vmovnrapd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(       vmovnraps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(    vmovnrngoapd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(    vmovnrngoaps,       move,    floatv,    0,    VRSZ,    0,    32)
    ...
    mkclass(    vpackstorehd,       move,      intv,    0,    VRSZ,    0,    32)
    mkclass(   vpackstorehpd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(   vpackstorehps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(    vpackstorehq,       move,      intv,    0,    VRSZ,    0,    64)
    mkclass(    vpackstoreld,       move,      intv,    0,    VRSZ,    0,    32)
    mkclass(   vpackstorelpd,       move,    floatv,    0,    VRSZ,    0,    64)
    mkclass(   vpackstorelps,       move,    floatv,    0,    VRSZ,    0,    32)
    mkclass(    vpackstorelq,       move,      intv,    0,    VRSZ,    0,    64)
